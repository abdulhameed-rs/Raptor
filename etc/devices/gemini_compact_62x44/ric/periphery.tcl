...
# bank description
####################################
create_instance -block GBOX_HV_40X2_VL -name u_GBOX_HV_40X2_VL  -logic_address [expr ${IO_CHAIN_GBOX_VL_START}] -parent PERIPHERY
create_instance -block GBOX_HP_40X2  -name u_GBOX_HP_40X2   -logic_address [expr ${IO_CHAIN_GBOX_HP_START}] -parent PERIPHERY
create_instance -block GBOX_HV_40X2_VR -name u_GBOX_HV_40X2_VR  -logic_address [expr ${IO_CHAIN_GBOX_VR_START}] -parent PERIPHERY
###############################################################################
