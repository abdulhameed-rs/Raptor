...
#jet commented out for FE -- 	redirect -tee -file ${REPORTS_DIR}/${REPORT_PREFIX}/check_mv_design.erc_mode {check_mv_design -erc_mode}
#jet commented out for FE -- 	redirect -tee -file ${REPORTS_DIR}/${REPORT_PREFIX}/check_mv_design {check_mv_design} ;# check_mv_design is also covered by check_design
if {[regexp $REPORT_PREFIX $INIT_DESIGN_BLOCK_NAME]} {
...
#jet commented out for FE -- 	redirect -tee -file ${REPORTS_DIR}/${REPORT_PREFIX}/check_mv_design.power_connectivity {check_mv_design -power_connectivity}
#jet commented out for FE -- 	redirect -tee -file ${REPORTS_DIR}/${REPORT_PREFIX}/check_pg_connectivity {check_pg_connectivity}
}
