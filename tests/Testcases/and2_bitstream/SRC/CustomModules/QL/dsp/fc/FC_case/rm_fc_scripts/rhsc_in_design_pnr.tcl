...
copy_block -from ${DESIGN_NAME}/${REDHAWK_IN_DESIGN_FROM_BLOCK_NAME} -to ${DESIGN_NAME}/${REDHAWK_IN_DESIGN_BLOCK_NAME}
current_block ${DESIGN_NAME}/${REDHAWK_IN_DESIGN_BLOCK_NAME}
link_block
