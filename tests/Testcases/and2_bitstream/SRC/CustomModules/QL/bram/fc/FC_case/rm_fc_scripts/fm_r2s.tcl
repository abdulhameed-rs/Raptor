...
set verification_ignore_unmatched_reference_blackbox_input true
...
read_verilog -i ${OUTPUTS_DIR}/${COMPILE_BLOCK_NAME}.ascii_files/$DESIGN_NAME.syn.fm.v.gz
