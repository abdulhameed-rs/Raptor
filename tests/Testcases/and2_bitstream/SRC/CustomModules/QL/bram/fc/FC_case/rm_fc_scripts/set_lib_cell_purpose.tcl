...
set TIE_LIB_CELL_PATTERN_LIST 		"*/*90c_tie*" ;# A list of TIE lib cell patterns to be included for optimization;
					;# Example : set TIE_LIB_CELL_PATTERN_LIST "*/TIE* */ttt*"
set HOLD_FIX_LIB_CELL_PATTERN_LIST 	"*/*90c_bufx2 */*90c_bufx3 */*90c_bufx4" ;# A list of hold time fixing lib cell patterns to be included only for hold
set CTS_LIB_CELL_PATTERN_LIST 		"*/*90c_ckbufdcapx4 */*90c_ckbufdcapx8 */*90c_ckbufdcapx12 */*90c_ckbufdcapx16 */*90c_ckand2x4 */*90c_ckand2x8 */*90c_ckand2x12 */*90c_ckmux21x4 */*90c_ckmux21x8 */*90c_ckmux21x12" ;# List of CTS lib cell patterns to be used by CTS; 
...
#Dont use D0 cell
#set_lib_cell_purpose -include none [get_lib_cells {*/*dhx*}]
set_lib_cell_purpose -include none [get_lib_cells {*/*xp6*}]
set_lib_cell_purpose -include none [get_lib_cells {*/*x1}]
set_lib_cell_purpose -include none [get_lib_cells {*/*x2}]
...
set_lib_cell_purpose -exclude {optimization power} [get_lib_cells */*xp6]
set_lib_cell_purpose -exclude {optimization power} [get_lib_cells */*x1]
