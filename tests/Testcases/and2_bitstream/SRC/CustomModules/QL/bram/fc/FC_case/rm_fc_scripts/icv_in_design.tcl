...
if { ($ICV_IN_DESIGN_BASE_FILL) && ($ICV_IN_DESIGN_BLOCK_NAME == "icv_in_design_base_fill") } {
...
if {$ICV_IN_DESIGN_DRC} {
	...
	########################################################################
        ...
        ## Unselect rules for DRC based on stage at which it is run
        if { $ICV_IN_DESIGN_BLOCK_NAME == "icv_in_design_drc_syndp" } {
          set drc_select_rules $ICV_IN_DESIGN_DRC_SELECT_RULES_SYNDP
          set drc_unselect_rules $ICV_IN_DESIGN_DRC_UNSELECT_RULES_SYNDP
          set excluded_cell_types $ICV_IN_DESIGN_DRC_EXCLUDED_CELL_TYPES_SYNDP
          set ignore_child_cell_errors $ICV_IN_DESIGN_DRC_IGNORE_CHILD_CELL_ERRORS_SYNDP
        } elseif { $ICV_IN_DESIGN_BLOCK_NAME == "icv_in_design_drc_synpnr" } {
          set drc_select_rules $ICV_IN_DESIGN_DRC_SELECT_RULES_SYNPNR
          set drc_unselect_rules $ICV_IN_DESIGN_DRC_UNSELECT_RULES_SYNPNR
         set excluded_cell_types $ICV_IN_DESIGN_DRC_EXCLUDED_CELL_TYPES_SYNPNR
          set ignore_child_cell_errors $ICV_IN_DESIGN_DRC_IGNORE_CHILD_CELL_ERRORS_SYNPNR
        } elseif { $ICV_IN_DESIGN_BLOCK_NAME == "icv_in_design_drc_finish" } {
          set drc_select_rules $ICV_IN_DESIGN_DRC_SELECT_RULES_FINISH
          set drc_unselect_rules $ICV_IN_DESIGN_DRC_UNSELECT_RULES_FINISH
          set excluded_cell_types $ICV_IN_DESIGN_DRC_EXCLUDED_CELL_TYPES_FINISH
          set ignore_child_cell_errors $ICV_IN_DESIGN_DRC_IGNORE_CHILD_CELL_ERRORS_FINISH
        } else {
...
if { ($ICV_IN_DESIGN_BASE_FILL) && ($ICV_IN_DESIGN_BLOCK_NAME == "icv_in_design_base_fill") } {
	...
	if {$ICV_IN_DESIGN_BASE_FILL_RUNDIR != ""} {
	  ...
	  eval $create_base_fill_cmd
          ...
          puts "RM-info: Please provide a valid value for ICV_IN_DESIGN_BASE_FILL_FOUNDRY_NODE if ICV_IN_DESIGN_BASE_FILL is set to 1" 
        }
}
