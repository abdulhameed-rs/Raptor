...
set DESIGN_NAME 		"iobhp40" ;# Required; name of the design to be worked on; used as the block name for save_block or copy_block operations
...
set REFERENCE_LIBRARY           [list \
                                /nfs_project/gemini/pd_home/input_gemini/tcbn16ffcllbwp7d5t16p96cpd_ccs.ndm \
                                /nfs_project/gemini/pd_home/input_gemini/tcbn16ffcllbwp7d5t16p96cpdlvt_ccs.ndm \
				/nfs_project/gemini/pd_home/input_gemini/ndm_stdcell/FUSIONCOMPILER_LIBPREP/icc2_cell_lib/RS_16_GPIO.ndm \
				/nfs_project/gemini/pd_home/INTERFACE/pnr/pnr_pass_hamza/pnr/iobhp40/design/ndm/delay_line_64tap_tc.ndm \
				/nfs_project/gemini/pd_home/INTERFACE/pnr/pnr_pass_hamza/pnr/iobhp40/design/ndm/phase_sel_1_8.ndm \
...
set TECH_FILE 			"/nfs_cadlib/cadlib/gemini/TSMC16NMFFC/library/pdk/tsmc/tech_file/RS_generated_tf/100422/PRTF_ICC_N16_11M_2Xa1Xd3Xe2Y2R_UTRDL_VHV_7.5T_96CPP_CPODE.17_1a.tf" 	;# A technology file; TECH_FILE and TECH_LIB are mutually exclusive ways to specify technology information; 
...
##################################################
#Please change the mentioned file for RTL for D45 : scripts/read_design.tcl
#/nfs_project/gemini/pd_home/A45/dc_synthesis/gemini_rtl_release_20220721/gemini/design/acpu_ss/acpu_ss/A45/crippled/andes_vip/models/common/hdl/sync_tasks.vh \
#/nfs_project/gemini/pd_home/A45/dc_synthesis/gemini_rtl_release_20220721/gemini/design/acpu_ss/acpu_ss/A45/crippled/andes_vip/models/pwm/hdl/pwm_model.v \


set RTL_SOURCE_FILES {  /nfs_project/gemini/hamza/backend/iobhp40/input/design/rtl/reset_sync.sv \
						/nfs_project/gemini/hamza/backend/iobhp40/input/design/rtl/sync_flop.sv \
						/nfs_project/gemini/hamza/backend/iobhp40/input/design/rtl/delay_tap.sv \
						/nfs_project/gemini/hamza/backend/iobhp40/input/design/rtl/gbox_bslip.sv \
						/nfs_project/gemini/hamza/backend/iobhp40/input/design/rtl/gbox_cdr4.sv \
						/nfs_project/gemini/hamza/backend/iobhp40/input/design/rtl/gbox_clk_gen.sv \
						/nfs_project/gemini/hamza/backend/iobhp40/input/design/rtl/gbox_des.sv \
						/nfs_project/gemini/hamza/backend/iobhp40/input/design/rtl/gbox_dly_adj.sv \
						/nfs_project/gemini/hamza/backend/iobhp40/input/design/rtl/gbox_ser.sv \
						/nfs_project/gemini/hamza/backend/iobhp40/input/design/rtl/gbox_iobp_i.sv \
						/nfs_project/gemini/hamza/backend/iobhp40/input/design/rtl/gbox_iobp_oe.sv \
						/nfs_project/gemini/hamza/backend/iobhp40/input/design/rtl/gbox_iobp_o.sv \
						/nfs_project/gemini/hamza/backend/iobhp40/input/design/rtl/nds_async_fifo_afe.v \
						/nfs_project/gemini/hamza/backend/iobhp40/input/design/rtl/nds_sync_fifo_afe.v \
						/nfs_project/gemini/hamza/backend/iobhp40/input/design/rtl/gbox_rx.sv \
						/nfs_project/gemini/hamza/backend/iobhp40/input/design/rtl/gbox_tx.sv \
						/nfs_project/gemini/hamza/backend/iobhp40/input/design/rtl/gbox_top.sv \
						/nfs_project/gemini/hamza/backend/iobhp40/input/design/rtl/gbox_hpio.sv \
						/nfs_project/gemini/hamza/backend/iobhp40/input/design/rtl/iobhp40.sv } ;# RTL files for RTL_SOURCE_FORMAT = verilog | sverilog | vhdl
...
set SDC_FILE                    "/nfs_project/gemini/hamza/backend/iobhp40/input/design/sdc/gbox_sdc.tcl"

set TCL_MCMM_SETUP_FILE		"../scripts/TCL_MCMM_SETUP_FILE.tcl"	;# Specify a Tcl script to create your corners, modes, scenarios and load respective constraints;
...
set DEF_FLOORPLAN_FILES			"/nfs_project/gemini/hamza/backend/iobhp40/run_fc/floorplan_1536x115.def"
...
set TCL_LIB_CELL_PURPOSE_FILE 		"/nfs_project/gemini/pd_home/common_scripts/tsmc_7.5t/set_lib_cell_purpose_tsmc.tcl" ;# A Tcl file which applies lib cell purpose related restrictions;
...
set HOLD_FIX_LIB_CELL_PATTERN_LIST 	"*/DEL* */BUF*" ;# A list of hold time fixing lib cell patterns to be included only for hold
...
set CTS_LIB_CELL_PATTERN_LIST 		"tcbn16ffcllbwp7d5t16p96cpdlvt/CKBD16BWP* tcbn16ffcllbwp7d5t16p96cpdlvt/CKBD12BWP* tcbn16ffcllbwp7d5t16p96cpdlvt/CKBD8BWP* tcbn16ffcllbwp7d5t16p96cpdlvt/CKBD4BWP* tcbn16ffcllbwp7d5t16p96cpdlvt/CKLNQD2BWP* tcbn16ffcllbwp7d5t16p96cpdlvt/CKLNQD8BWP*" ;# List of CTS lib cell patterns to be used by CTS; 
...
set CLOCK_OPT_CTS_ACTIVE_SCENARIO_LIST  "func::rcworst_CCworst_T_125 func::cworst_CCworst_T_m40 func::rcworst_CCworst_125 func::cbest_CCbest_m40 func::cworst_CCworst_m40" ;# A subset of scenarios to be made active during clock_opt_cts step;
					;# once set, the list of active scenarios is saved and carried over to subsequent steps;
set ROUTE_OPT_ACTIVE_SCENARIO_LIST 	"func::rcworst_CCworst_T_125 func::cworst_CCworst_T_m40 func::rcworst_CCworst_125 func::cbest_CCbest_m40 func::cworst_CCworst_m40" ;# A subset of scenarios to be made active during route_opt step;
					;# once set, the list of active scenarios is saved and carried over to subsequent steps;
...
set ROUTE_AUTO_ACTIVE_SCENARIO_LIST 	"$ROUTE_OPT_ACTIVE_SCENARIO_LIST" ;# A subset of scenarios to be made active during route_auto step;
					;# once set, the list of active scenarios is saved and carried over to subsequent steps;
					;# with GRE, the same set of scenarios are recommended to be used across clock_opt_opto, route_auto, and route_opt
set CHIP_FINISH_ACTIVE_SCENARIO_LIST 	"func::rcworst_CCworst_T_125 func::cworst_CCworst_T_m40 func::rcworst_CCworst_125 func::cbest_CCbest_m40 func::cworst_CCworst_m40" ;# A subset of scenarios to be made active during chip_finish step.
					;# once set, the list of active scenarios is saved and carried over to subsequent steps.
...
/nfs_project/gemini/pd_home/from_rs/gemini_rtl_release_0_5_1_20221004/gemini/design/ip/GbE \
/nfs_project/gemini/pd_home/from_rs/gemini_rtl_release_0_5_1_20221004/gemini/design/ip/GbE/hdl \
...
/nfs_project/gemini/pd_home/from_rs/gemini_rtl_release_0_5_1_20221004/gemini/design/ip/USB/phy_behav \
/nfs_project/gemini/pd_home/from_rs/gemini_rtl_release_0_5_1_20221004/gemini/design/ip/USB/rtl \
/nfs_project/gemini/pd_home/from_rs/gemini_rtl_release_0_5_1_20221004/gemini/design/ip/USB/rtl/usbhs/adma \
/nfs_project/gemini/pd_home/from_rs/gemini_rtl_release_0_5_1_20221004/gemini/design/ip/USB/rtl/usbhs/cusb2 \
