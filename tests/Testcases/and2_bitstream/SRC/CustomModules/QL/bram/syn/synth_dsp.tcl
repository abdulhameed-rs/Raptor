...
analyze -format sverilog ../rtl/ql_dsp_$VENDOR_ID.sv 

elaborate ql_dsp_$VENDOR_ID

set FREQ 3.00
create_clock -name clk -period ${FREQ} clock_i
set_max_delay ${FREQ} -from a_i -to z_o
set_max_delay ${FREQ} -from b_i -to z_o
set_max_transition 1.0 ql_dsp_$VENDOR_ID
...
write_file -hierarchy -output ql_dsp_$VENDOR_ID.ddc
ungroup -all -flatten
write -format verilog -out ../../ql_dsp_$VENDOR_ID.v -hier ql_dsp_$VENDOR_ID
